...
class TerminationManager:
    ...
    def check(self, state: LocomotionTaskState, base_contact: bool) -> tuple[bool, dict[str, float]]:
        ...
        terminated = too_low or too_high or too_tilted or invalid or base_hit
        return terminated, {
