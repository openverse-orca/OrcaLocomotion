...
> **Required terrain rendering assets:** Subscribe to
> **`OrcaPrimitiveTerrainXml`** and **`MjlabRough5x5xml_20260527`** in the Orca
> cloud asset management platform. They are the rendering assets corresponding
> to the two terrain height fields.
